...
if (!empty($_GET[GET_PARAM_SEARCH_TEXT])){
    ...
    foreach ($ratings as $rating) {
        $kleineauch = strtoupper($rating['text']);
        if (strpos($kleineauch, $searchTerm) !== false) {
            $showRatings[] = $rating;
        }
    }
...
<html lang="de">
    ...
    <body>
    <form method="get">
      <label for="language"><?php chooselanguage(9); ?></label>
      <input type="radio" name="language" value="en" id="en">
      <label for="en"><?php chooselanguage(8); ?></label>
    ...
    ?>
        <ul>
            <li><?php chooselanguage(4); echo $meal['price_intern']; ?>0€</li>
            <li><?php chooselanguage(5); echo $meal['price_extern']; ?>0€</li>
        </ul>
        <form method="get">
          <label for="show_description"><?php chooselanguage(15)?></label>
          <input type="hidden" id="show_description" name="show_description" value="0">
          <input type="checkbox" id="show_description" name="show_description" value="1">
          <br>
          <input type="submit" value=<?php chooselanguage(16);?>>
          <?php
    ...
    ?>
        <form method="get">
            ...
            <input id="search_text" type="text" name="search_text" value=<?php if(!isset($_GET['search_text'])){echo null;}
